...
public class CowardMonster : NoneAttackMonster
{
    List<PathNode> pathNodes = new List<PathNode>();
    [SerializeField] Transform player;

    [SerializeField] bool isHitState = false; // 맞을때만 활성화
    bool isMoving = false; // 도망칠때만 활성화
    ...
    /****************  행동  ******************/
    /******************************************/
    public E_BT DoIsHitByPlayer() { return (isHitState) ? E_BT.BT_SUCCESS : E_BT.BT_FAIL; }

    public E_BT DoHitRunAway()
    {
        Debug.Log("맞아서 도망중");
        if (isMoving) return E_BT.BT_SUCCESS;
