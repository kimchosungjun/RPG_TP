...
public class TestCsvReader : MonoBehaviour
{
    ...
    public void OnGUI()
    {
        ...
        {
            skillActionSO.SetSOData(tableMgr.character.GetPlayerAttackSkillTableData(PlayerEnums.ATTACK_SKILL.WARRIOR_ULTIMATE, 1));
            attackActionSO.SetSOData(tableMgr.character.GetPlayerNormalAttackData(PlayerEnums.TYPEID.WARRIOR, 2));
            buffActionSO.SetSOData(tableMgr.character.GetPlayerBuffSkillTableData(PlayerEnums.BUFF_SKILL.WARRIOR_ROAR, 3));
        }
