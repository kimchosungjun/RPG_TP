...
public class SimpleCameraController : MonoBehaviour
{
    ...
    private void OnOriginShift(Vector3Double newOrigin, Vector3Double previousOrigin){
        ...
        m_TargetCameraState.x += offset.x;
        m_TargetCameraState.y += offset.y;
        m_TargetCameraState.z += offset.z;

        m_InterpolatingCameraState.x += offset.x;
        m_InterpolatingCameraState.y += offset.y;
        m_InterpolatingCameraState.z += offset.z;
    ...
    void Update()
    {
        ...
        boost = Mathf.Clamp(boost+Input.mouseScrollDelta.y * 0.2f, 0, 100);
