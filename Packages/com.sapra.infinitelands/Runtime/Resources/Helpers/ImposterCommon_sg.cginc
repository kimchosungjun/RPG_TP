...
void ImposterVertex_half(in half4 vertex, in half2 texcoord, out half4 ivertex, out half2 iuv, out half2 igrid, out half4 iframe0,out half4 iframe1,out half4 iframe2)
{
...
void ImposterSample_half( in half4 vertex, in half2 uv, in half2 grid, in half4 iframe0, in half4 iframe1, in half4 iframe2, in UnityTexture2D _ImposterWorldNormalDepthTex, in UnityTexture2D _ImposterBaseTex, out half4 baseTex, out half4 worldNormal )//, out half depth )
{
